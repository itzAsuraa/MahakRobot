...
from MahakRobot import NO_LOAD
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 5: 5* (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("ʜᴏᴍᴇ", callback_data="Main_help"),
                EqInlineKeyboardButton("ɴᴇxᴛ", callback_data="{}_next({})".format(prefix, modulo_page)),
            )
        ]
