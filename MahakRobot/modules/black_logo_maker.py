...
from MahakRobot import OWNER_ID, BOT_USERNAME, BOT_NAME
from MahakRobot import telethn as tbot
from MahakRobot.modules.nightmode import button_row
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./MahakRobot/resources/fonts/*")
