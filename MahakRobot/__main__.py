...
DONATE_STRING = f"""❅ ʜᴇʏ ʙᴀʙʏ, ʜᴀᴩᴩʏ ᴛᴏ ʜᴇᴀʀ ᴛʜᴀᴛ ʏᴏᴜ ᴡᴀɴɴᴀ ᴅᴏɴᴀᴛᴇ. ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @god_ravana ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @ravan_lankaa ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            time.sleep(0.4)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 5%")
            time.sleep(0.3)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 15%")
            time.sleep(0.3)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 24%")
            time.sleep(0.3)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 39%")
            time.sleep(0.3)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 50%")
            time.sleep(0.3)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 80%")
            time.sleep(0.3)
            lol.edit_text("ʟᴏᴀᴅɪɪɴɢ... 90%")
            time.sleep(0.6)
            lol.edit_text("ʟᴏᴀᴅɪɴɢ... 97%")
            time.sleep(0.7)
        ...
        update.effective_message.reply_photo(
            random.choice(NYKAA),
            caption="⬤ ˹ ᴍᴀʜᴀᴋ ꭙ ʀᴏʙᴏᴛ™ ♡゙ ɪs ᴀʟɪᴠᴇ ʙᴀʙʏ.\n\n⬤ ᴜᴘᴛɪᴍᴇ ➥ <code>{}</code>".format(
                uptime
            ),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="avisha_back"),
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/god_ravana"
                        ),
                    ],
                ]
            ),
        ...
        query.message.edit_caption(f"""✿ ʜᴇʀᴇ ɪꜱ ʜᴇʟᴘ ᴍᴇɴᴜ ꜰᴏʀ ꜱᴘᴀᴍ ʀᴀɪᴅ ✿""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴄ-sᴏᴏɴ", callback_data="Music_roy_admin"
                        ),
                        InlineKeyboardButton(
                            text="ᴄ-sᴏᴏɴ", callback_data="Music_roy_play"
                        ),
                    ],
                    [
